...
> Última atualização automática: 16/03/2026, 09:54
...
|---|---|---|---|
| `api/` | 40 arquivos | 450.1 KB | 16/03/2026 |
| `src/components/` | 107 arquivos | 807.6 KB | 16/03/2026 |
| `src/pages/` | 0 arquivos | 0 KB | N/A |
| `src/contexts/` | 2 arquivos | 2.3 KB | 16/03/2026 |
| `src/types/` | 6 arquivos | 29.7 KB | 16/03/2026 |
| `database/` | 0 arquivos | 109.5 KB | 16/03/2026 |
| `scripts/` | 1 arquivos | 6.8 KB | 16/03/2026 |
