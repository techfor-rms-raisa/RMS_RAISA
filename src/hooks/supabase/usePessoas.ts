    ...
    try {
      ...
      const mappedPessoas: Pessoa[] = (data || []).map((pessoa: any) => {
        ...
        return {
          ...
          cep: pessoa.cep,
          rg: pessoa.rg,
          valor_hora_atual: pessoa.valor_hora_atual,
          pretensao_valor_hora: pessoa.pretensao_valor_hora,
          ja_trabalhou_pj: pessoa.ja_trabalhou_pj,
          aceita_pj: pessoa.aceita_pj,
          possui_empresa: pessoa.possui_empresa,
          aceita_abrir_empresa: pessoa.aceita_abrir_empresa,
