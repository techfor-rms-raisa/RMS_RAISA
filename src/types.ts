...
export interface User {
  ...
  perfil_id?: number | null; // Campo adicionado para compatibilidade com Supabase
  perfil?: any | null; // Campo adicionado para compatibilidade com Supabase
}
...
export interface UsuarioCliente {
  ...
  ativo: boolean;
  analista_rs_id: number | null;
  cliente?: any; // Campo adicionado para compatibilidade com useSupabaseData
  gestor_rs_id?: number | null; // Campo do Supabase
  gestor_rs?: any; // Relacionamento opcional
}
...
export interface CoordenadorCliente {
  ...
  celular?: string; // Formato: DDD-99999-9999 (Ex: 011-98833-8182)
  ativo: boolean;
  gestor?: any; // Campo adicionado para compatibilidade com useSupabaseData
}
...
export interface ConsultantReport {
    ...
    content: string;
    createdAt: string;
    created_at?: string; // Campo snake_case do Supabase
    data_relatorio?: string; // Campo do Supabase
...
export interface Consultant {
  ...
  valor_pagamento?: number; // Valor que o consultor recebe (salário)
  ...
  recommendations?: Recommendation[]; // Campo adicionado para Quarentena
...
export interface Client {
  ...
  id_gestor_rs: number;
  vip?: boolean; // Campo adicionado para compatibilidade com Supabase
}

// Alias para compatibilidade com componentes que usam 'Cliente'
...
export interface EmailTemplate {
    ...
    lastUpdated?: string;
    created_at?: string; // Campo snake_case do Supabase
    updated_at?: string; // Campo snake_case do Supabase
}
...
export interface ComplianceCampaign {
    ...
    // Campos snake_case para compatibilidade com Supabase
...
export interface Vaga {
    ...
    modalidade?: string;
    beneficios?: string[];
    // Campos adicionados para compatibilidade com Supabase
...
export interface Pessoa {
    ...
    observacoes?: string;
    createdAt?: string;
    cpf?: string; // Campo adicionado para compatibilidade com Supabase
    created_at?: string; // Campo snake_case do Supabase
}
...
export interface DadosVagaPrioridade {
    ...
    // Campos adicionados para compatibilidade com vagaPriorizacaoService
...
// --- TIPOS PARA SUPABASE RECOMMENDATION SERVICE ---
...
export type RecommendationCategory = 
    ...
    | 'SUPORTE' 
    | 'OBSERVAÇÃO'
    | 'FEEDBACK'; // Adicionado para compatibilidade
